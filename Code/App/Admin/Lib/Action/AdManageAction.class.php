...
class AdManageAction  extends CommonAction{
	...
	public function index(){
		...
		// 查询出所有的信息
		$AdManageInfo = $this->memberLinkPage($AdManage,$where,5,'aid desc',array($this->table_pre.'ad_manage'=>'admanage',$this->table_pre.'ad_size'=>'adsize'),'admanage.*,adsize.size_type');
